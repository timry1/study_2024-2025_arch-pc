...
Целью работы является освоение процедуры оформления отчетов с помощтю легковесного языка разметки Markdown
...
6. Заполните и скомпилируйте отчет с использованием Makefile.
...
3. Удаление файлов (См Рис 4-5)
![gg](image/1.png){#fig:001 width=100%}

(Рис4)
![gg](image/3.png){#fig:001 width=100%}

(Рис5)

4. Открыть файл report.md (Рис6)
![gg](image/1.png){#fig:001 width=100%}

(Рис6)

5. Заполнить и скомпилировать отчет (См Рис 7)
![gg](image/4.png){#fig:001 width=100%}

(Рис7)

6. Загрузить файлы на GitHub (См Рис 8)
![gg](image/5.png){#fig:001 width=100%}

(Рис8)

7. Выполнить самостоятельную работу (Рис 9)
![gg](image/6.png){#fig:001 width=100%}
